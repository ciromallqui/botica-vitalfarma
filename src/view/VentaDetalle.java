...
//        DProducto.loadProducto(tac);
    ...
    private void tableVenta(){
        ...
        tventa.getColumnModel().getColumn(7).setMinWidth(130);
        tventa.getColumnModel().getColumn(7).setMaxWidth(130);
            ...
            if(modelod.getRowCount() > 0){
                ...
                if(evt.getKeyChar()==KeyEvent.VK_ENTER){
                    if(tdetalle.getSelectedColumn()==3){
                        ...
                        CProducto producto = productoController.consultarProducto(filtro[0], filtro[1], 0);
    ...
    private void bguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bguardarActionPerformed
        ...
        try{
            if(modelod.getRowCount()>0 && !lbmonto.getText().equals("0.00")){
                ...
                ventaController.mostrarProductoVentaDiario(modelov, "", Main.usuario());
